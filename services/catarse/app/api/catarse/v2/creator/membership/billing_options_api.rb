      ...
      module Membership
        class BillingOptionsAPI < Grape::API
          ...
          get '/tiers/:tier_id/billing_options' do
            ...
            present :billing_options, result.billing_options, with: ::Creator::Membership::BillingOptionEntity
          end
          ...
          post '/tiers/:tier_id/billing_options' do
            ...
            present :billing_option, result.billing_option, with: ::Creator::Membership::BillingOptionEntity
          end
