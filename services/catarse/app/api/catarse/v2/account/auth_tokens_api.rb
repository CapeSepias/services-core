    ...
    module Account
      class AuthTokensAPI < Grape::API
        ...
        post '/auth_tokens' do
          ...
          result = ::Account::AuthTokens::Generate.result(attributes: credential_params)
        ...
        get '/auth_tokens/me' do
          ...
          if user.present?
            auth_token = ::Account::AuthToken.encode(payload: { user_id: user.id }, expires_at: 1.hour.from_now)
