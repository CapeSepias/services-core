...
RSpec.describe Catarse::V2::Creator::Membership::BillingOptionsAPI, type: :api do
  mock_request_authentication

  include_examples 'authenticate routes'

  describe 'GET /v2/creator/membership/tiers/:tier_id/billing_options' do
    ...
    it 'returns tier`s billing options' do
      get "/api/v2/creator/membership/tiers/#{billing_option.tier_id}/billing_options"
      expected_response = {
        billing_options: Creator::Membership::BillingOptionEntity.represent([billing_option])
      }.to_json
  ...
  describe 'POST /v2/creator/membership/tiers/:tier_id/billing_options' do
    ...
    it 'returns created billing option' do
      post "/api/v2/creator/membership/tiers/#{tier_id}/billing_options",
        params: { billing_option: billing_option_params }
      expected_response = { billing_option: Creator::Membership::BillingOptionEntity.represent(billing_option) }.to_json
  ...
  describe 'PUT /v2/creator/membership/billing_options/:id' do
    let(:billing_option) { create(:membership_billing_option) }
    ...
    it 'returns updated billing_option' do
      put "/api/v2/creator/membership/billing_options/#{billing_option.id}",
        params: { billing_option: billing_option_params }
      expected_response = { billing_option: Creator::Membership::BillingOptionEntity.represent(billing_option) }.to_json
  ...
  describe 'DELETE /v2/creator/membership/billing_options/:id' do
    let(:billing_option) { create(:membership_billing_option) }
    ...
    it 'return status 204 - no_content' do
      delete "/api/v2/creator/membership/billing_options/#{billing_option.id}"
