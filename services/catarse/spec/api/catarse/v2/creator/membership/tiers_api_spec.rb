...
RSpec.describe Catarse::V2::Creator::Membership::TiersAPI, type: :api do
  mock_request_authentication

  include_examples 'authenticate routes'

  describe 'GET /v2/creator/membership/projects/:project_id/tiers' do
    ...
    it 'returns project tiers' do
      get "/api/v2/creator/membership/projects/#{project_id}/tiers"
      expected_response = { tiers: Creator::Membership::TierEntity.represent(tiers) }.to_json
  ...
  describe 'POST /v2/creator/membership/tiers' do
    ...
    it 'returns created tier' do
      post "/api/v2/creator/membership/projects/#{project_id}/tiers", params: { tier: tier_params }
      expected_response = { tier: Creator::Membership::TierEntity.represent(tier) }.to_json
  ...
  describe 'PUT /v2/creator/membership/tiers/:id' do
    ...
    it 'returns updated tier' do
      put "/api/v2/creator/membership/tiers/#{tier.id}", params: { tier: tier_params }
      expected_response = { tier: Creator::Membership::TierEntity.represent(tier) }.to_json
  ...
  describe 'DELETE /v2/creator/membership/tiers/:id' do
    let(:tier) { create(:membership_tier) }
    ...
    it 'return status 204 - no_content' do
      delete "/api/v2/creator/membership/tiers/#{tier.id}"
