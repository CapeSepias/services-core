...
RSpec.describe Catarse::V2::Account::AuthTokensAPI do
  include_examples 'authenticate routes', public_paths: [
    'POST /v2/account/auth_tokens',
    'GET /v2/account/auth_tokens/me'
  ]

  describe 'POST /v2/account/auth_tokens' do
    ...
    context 'when credential is valid' do
      before do
        allow(Account::AuthTokens::Generate).to receive(:result)
          .with(attributes: credential_params)
          .and_return(ServiceActor::Result.new(auth_token: auth_token))
      end

      it 'returns http status CREATED' do
        post '/api/v2/account/auth_tokens', params: { credential: credential_params }
  ...
  describe 'GET /v2/account/auth_tokens/me' do
    ...
    context 'when warden has user authenticated' do
      ...
      it 'returns http status OK' do
        get '/api/v2/account/auth_tokens/me'
      ...
      it 'renders generated auth token' do
        ...
        payload = Account::AuthToken.decode(auth_token: parsed_response['auth_token'])
