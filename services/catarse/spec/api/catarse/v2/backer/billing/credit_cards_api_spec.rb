...
RSpec.describe Catarse::V2::Backer::Billing::CreditCardsAPI, type: :api do
  mock_request_authentication

  include_examples 'authenticate routes'

  describe 'POST /v2/backer/billing/credit_cards' do
    ...
    it 'returns created/updated credit_card' do
      post '/api/v2/backer/billing/credit_cards', params: { credit_card: credit_card_params }
      expected_response = { credit_card: Backer::Billing::CreditCardEntity.represent(credit_card) }.to_json
