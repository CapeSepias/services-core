...
RSpec.describe Catarse::V2::Backer::Billing::InstallmentSimulationsAPI, type: :api do
  include_examples 'authenticate routes', public_paths: ['GET /v2/backer/billing/installment_simulations']

  describe 'POST /v2/backer/billing/installment_simulations' do
    let(:params) do
    ...
    it 'returns installment simulations' do
      get '/api/v2/backer/billing/installment_simulations', params: params
