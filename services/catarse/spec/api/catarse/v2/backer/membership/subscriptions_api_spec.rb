...
RSpec.describe Catarse::V2::Backer::Membership::SubscriptionsAPI, type: :api do
  mock_request_authentication

  include_examples 'authenticate routes'

  describe 'POST /v2/backer/membership/subscriptions' do
    ...
    it 'returns created subscription' do
      post '/api/v2/backer/membership/subscriptions', params: { subscription: subscription_params }
      expected_response = { subscription: Backer::Membership::SubscriptionEntity.represent(subscription) }.to_json
